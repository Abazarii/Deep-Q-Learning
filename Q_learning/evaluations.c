...
#define __PYX_HAVE__evaluations
#define __PYX_HAVE_API__evaluations
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'evaluations' */
...
static PyObject *__pyx_f_11evaluations_taillard_acceleration(__Pyx_memviewslice, __Pyx_memviewslice, int, int, int, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_11evaluations_tie_breaking(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int, int, int, int); /*proto*/
static PyObject *__pyx_f_11evaluations_calculate_completion_times(__Pyx_memviewslice, __Pyx_memviewslice, int, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_11evaluations_idle_times_calc(__Pyx_memviewslice, __Pyx_memviewslice, int, int __pyx_skip_dispatch); /*proto*/
static struct __pyx_array_obj *__pyx_array_new(PyObject *, Py_ssize_t, char *, char *, char *); /*proto*/
...
#define __Pyx_MODULE_NAME "evaluations"
extern int __pyx_module_is_main_evaluations;
int __pyx_module_is_main_evaluations = 0;
...
static const char __pyx_k_job_to_insert[] = "job_to_insert";
static const char __pyx_k_pyx_getbuffer[] = "__pyx_getbuffer";
static const char __pyx_k_reduce_cython[] = "__reduce_cython__";
static const char __pyx_k_View_MemoryView[] = "View.MemoryView";
static const char __pyx_k_allocate_buffer[] = "allocate_buffer";
static const char __pyx_k_dtype_is_object[] = "dtype_is_object";
static const char __pyx_k_machines_number[] = "machines_number";
...
static PyObject *__pyx_n_s_job_to_insert;
static PyObject *__pyx_n_s_join;
static PyObject *__pyx_n_s_machines_number;
...
static PyObject *__pyx_pf_11evaluations_taillard_acceleration(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_sequence, __Pyx_memviewslice __pyx_v_processing_times, int __pyx_v_job_to_insert, int __pyx_v_machines_number, int __pyx_v_use_tie_breaking); /* proto */
static PyObject *__pyx_pf_11evaluations_2calculate_completion_times(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_sequence, __Pyx_memviewslice __pyx_v_processing_times, int __pyx_v_machines_number); /* proto */
static PyObject *__pyx_pf_11evaluations_4idle_times_calc(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_sequence, __Pyx_memviewslice __pyx_v_processing_times, int __pyx_v_machines_number); /* proto */
...
static PyObject *__pyx_pw_11evaluations_1taillard_acceleration(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_11evaluations_taillard_acceleration(__Pyx_memviewslice __pyx_v_sequence, __Pyx_memviewslice __pyx_v_processing_times, int __pyx_v_job_to_insert, int __pyx_v_machines_number, int __pyx_v_use_tie_breaking, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_ms[0x321];
  int __pyx_v_funct[0x321][61];
  int __pyx_v_position[0x321][61];
  int __pyx_v_approx[0x321][61];
  ...
  int __pyx_v_jp;
  int __pyx_v_pos;
  PyObject *__pyx_v_best_makespans = 0;
  PyObject *__pyx_v_best_positions = 0;
 ...
 */
  __pyx_v_ip = (__pyx_v_sequence_length + 1);
 ...
 * 			ip -= 1
 */
      ((__pyx_v_position[__pyx_v_i])[0]) = 0;
 ...
 * 		funct[i][0] = 0
 */
      ((__pyx_v_approx[__pyx_v_ip])[(__pyx_v_machines_number + 1)]) = 0;
 ...
 */
    __pyx_v_jp = (__pyx_v_machines_number + 1);
 ...
 * 				position[0][j] = 0
 */
    __pyx_t_6 = (__pyx_v_machines_number + 1);
    __pyx_t_7 = __pyx_t_6;
 ...
 * 			if i < sequence_length+1:
 */
        ((__pyx_v_position[0])[__pyx_v_j]) = 0;
 ...
 * 
 */
        ((__pyx_v_approx[(__pyx_v_sequence_length + 1)])[((__pyx_v_machines_number + 1) - __pyx_v_j)]) = 0;
 ...
 * 				else:
 */
        __pyx_t_5 = ((((__pyx_v_position[__pyx_v_i])[(__pyx_v_j - 1)]) > ((__pyx_v_position[(__pyx_v_i - 1)])[__pyx_v_j])) != 0);
        if (__pyx_t_5) {
 ...
 */
          ...
          ((__pyx_v_position[__pyx_v_i])[__pyx_v_j]) = (((__pyx_v_position[__pyx_v_i])[(__pyx_v_j - 1)]) + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_processing_times.data + __pyx_t_10 * __pyx_v_processing_times.strides[0]) ) + __pyx_t_11 * __pyx_v_processing_times.strides[1]) ))));
 ...
 */
        /*else*/ {
          ...
          ((__pyx_v_position[__pyx_v_i])[__pyx_v_j]) = (((__pyx_v_position[(__pyx_v_i - 1)])[__pyx_v_j]) + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_processing_times.data + __pyx_t_11 * __pyx_v_processing_times.strides[0]) ) + __pyx_t_10 * __pyx_v_processing_times.strides[1]) ))));
        }
        __pyx_L10:;
 ...
 * 				else:
 */
        __pyx_t_5 = ((((__pyx_v_approx[__pyx_v_ip])[(__pyx_v_jp + 1)]) > ((__pyx_v_approx[(__pyx_v_ip + 1)])[__pyx_v_jp])) != 0);
        if (__pyx_t_5) {
 ...
 */
          ...
          __pyx_t_10 = ((*((int *) ( /* dim=0 */ (__pyx_v_sequence.data + __pyx_t_9 * __pyx_v_sequence.strides[0]) ))) - 1);
          __pyx_t_11 = (__pyx_v_jp - 1);
          ((__pyx_v_approx[__pyx_v_ip])[__pyx_v_jp]) = (((__pyx_v_approx[__pyx_v_ip])[(__pyx_v_jp + 1)]) + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_processing_times.data + __pyx_t_10 * __pyx_v_processing_times.strides[0]) ) + __pyx_t_11 * __pyx_v_processing_times.strides[1]) ))));
 ...
 */
        /*else*/ {
          ...
          ((__pyx_v_approx[__pyx_v_ip])[__pyx_v_jp]) = (((__pyx_v_approx[(__pyx_v_ip + 1)])[__pyx_v_jp]) + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_processing_times.data + __pyx_t_11 * __pyx_v_processing_times.strides[0]) ) + __pyx_t_10 * __pyx_v_processing_times.strides[1]) ))));
        }
        __pyx_L11:;
 ...
 * 			else:
 */
      __pyx_t_5 = ((((__pyx_v_funct[__pyx_v_i])[(__pyx_v_j - 1)]) > ((__pyx_v_position[(__pyx_v_i - 1)])[__pyx_v_j])) != 0);
      if (__pyx_t_5) {
 ...
 */
        __pyx_t_9 = (__pyx_v_job_to_insert - 1);
        __pyx_t_10 = (__pyx_v_j - 1);
        ((__pyx_v_funct[__pyx_v_i])[__pyx_v_j]) = (((__pyx_v_funct[__pyx_v_i])[(__pyx_v_j - 1)]) + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_processing_times.data + __pyx_t_9 * __pyx_v_processing_times.strides[0]) ) + __pyx_t_10 * __pyx_v_processing_times.strides[1]) ))));
 ...
 */
      /*else*/ {
        __pyx_t_10 = (__pyx_v_job_to_insert - 1);
        __pyx_t_9 = (__pyx_v_j - 1);
        ((__pyx_v_funct[__pyx_v_i])[__pyx_v_j]) = (((__pyx_v_position[(__pyx_v_i - 1)])[__pyx_v_j]) + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_processing_times.data + __pyx_t_10 * __pyx_v_processing_times.strides[0]) ) + __pyx_t_9 * __pyx_v_processing_times.strides[1]) ))));
      }
      __pyx_L12:;
    }
  }
 ...
 * 
 */
  __pyx_t_12 = PyList_New(0); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 85, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  __pyx_v_best_makespans = ((PyObject*)__pyx_t_12);
  __pyx_t_12 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_12);
  __pyx_v_best_positions = ((PyObject*)__pyx_t_12);
  __pyx_t_12 = 0;
 ...
 * 				ms[i] = pos
 */
      __pyx_v_pos = (((__pyx_v_funct[__pyx_v_i])[__pyx_v_j]) + ((__pyx_v_approx[__pyx_v_i])[__pyx_v_j]));
 ...
 */
      __pyx_t_5 = ((__pyx_v_pos > (__pyx_v_ms[__pyx_v_i])) != 0);
      if (__pyx_t_5) {
 ...
 */
        (__pyx_v_ms[__pyx_v_i]) = __pyx_v_pos;
 ...
 */
    __pyx_t_12 = __Pyx_PyInt_From_int((__pyx_v_ms[__pyx_v_i])); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 95, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
    __pyx_t_13 = __Pyx_PyList_Append(__pyx_v_best_makespans, __pyx_t_12); if (unlikely(__pyx_t_13 == ((int)-1))) __PYX_ERR(0, 95, __pyx_L1_error)
 ...
 * 			best_makespan = ms[i]
 */
    __pyx_t_12 = __Pyx_PyInt_From_int(__pyx_v_i); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 96, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
    __pyx_t_13 = __Pyx_PyList_Append(__pyx_v_best_positions, __pyx_t_12); if (unlikely(__pyx_t_13 == ((int)-1))) __PYX_ERR(0, 96, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
 ...
 */
    __pyx_t_14 = (((__pyx_v_ms[__pyx_v_i]) < __pyx_v_best_makespan) != 0);
    if (!__pyx_t_14) {
    } else {
      __pyx_t_5 = __pyx_t_14;
      goto __pyx_L19_bool_binop_done;
    }
    __pyx_t_14 = ((__pyx_v_best_makespan == 0) != 0);
    __pyx_t_5 = __pyx_t_14;
 ...
 * 
 */
    __pyx_t_16 = __pyx_format_from_typeinfo(&__Pyx_TypeInfo_int); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 104, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_16);
    __pyx_t_12 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)0x321), ((Py_ssize_t)61)); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 104, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
    __pyx_t_15 = __pyx_array_new(__pyx_t_12, sizeof(int), PyBytes_AS_STRING(__pyx_t_16), (char *) "c", (char *) __pyx_v_position);
    if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 104, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_15);
    __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
    __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
    __pyx_t_17 = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(((PyObject *)__pyx_t_15), PyBUF_WRITABLE); if (unlikely(!__pyx_t_17.memview)) __PYX_ERR(0, 104, __pyx_L1_error)
    __Pyx_DECREF(((PyObject *)__pyx_t_15)); __pyx_t_15 = 0;
    __pyx_t_12 = __pyx_format_from_typeinfo(&__Pyx_TypeInfo_int); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 104, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
    __pyx_t_16 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)0x321), ((Py_ssize_t)61)); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 104, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_16);
    __pyx_t_15 = __pyx_array_new(__pyx_t_16, sizeof(int), PyBytes_AS_STRING(__pyx_t_12), (char *) "c", (char *) __pyx_v_funct);
    if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 104, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_15);
    __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
    __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
    __pyx_t_18 = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(((PyObject *)__pyx_t_15), PyBUF_WRITABLE); if (unlikely(!__pyx_t_18.memview)) __PYX_ERR(0, 104, __pyx_L1_error)
    __Pyx_DECREF(((PyObject *)__pyx_t_15)); __pyx_t_15 = 0;
    __pyx_t_16 = __pyx_format_from_typeinfo(&__Pyx_TypeInfo_int); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 104, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_16);
    __pyx_t_12 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)0x321)); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 104, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_12);
    __pyx_t_15 = __pyx_array_new(__pyx_t_12, sizeof(int), PyBytes_AS_STRING(__pyx_t_16), (char *) "fortran", (char *) __pyx_v_ms);
    if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 104, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_15);
    __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
    __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
    __pyx_t_19 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(((PyObject *)__pyx_t_15), PyBUF_WRITABLE); if (unlikely(!__pyx_t_19.memview)) __PYX_ERR(0, 104, __pyx_L1_error)
    __Pyx_DECREF(((PyObject *)__pyx_t_15)); __pyx_t_15 = 0;
    __pyx_t_16 = __pyx_f_11evaluations_tie_breaking(__pyx_v_processing_times, __pyx_t_17, __pyx_t_18, __pyx_t_19, __pyx_v_job_to_insert, __pyx_v_best_position, __pyx_v_sequence_length, __pyx_v_machines_number); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 104, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_16);
    ...
    __pyx_t_4 = __Pyx_PyInt_As_int(__pyx_t_16); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 104, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
 ...
 */
  ...
  __pyx_t_16 = __Pyx_PyInt_From_int(__pyx_v_best_position); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 105, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_16);
  __pyx_t_12 = __Pyx_PyInt_From_int(__pyx_v_best_makespan); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 105, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  __pyx_t_20 = PyTuple_New(4); if (unlikely(!__pyx_t_20)) __PYX_ERR(0, 105, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_20);
  __Pyx_GIVEREF(__pyx_t_16);
  PyTuple_SET_ITEM(__pyx_t_20, 0, __pyx_t_16);
  __Pyx_GIVEREF(__pyx_t_12);
  PyTuple_SET_ITEM(__pyx_t_20, 1, __pyx_t_12);
  __Pyx_INCREF(__pyx_v_best_positions);
  __Pyx_GIVEREF(__pyx_v_best_positions);
  PyTuple_SET_ITEM(__pyx_t_20, 2, __pyx_v_best_positions);
  __Pyx_INCREF(__pyx_v_best_makespans);
  __Pyx_GIVEREF(__pyx_v_best_makespans);
  PyTuple_SET_ITEM(__pyx_t_20, 3, __pyx_v_best_makespans);
  __pyx_t_16 = 0;
  __pyx_t_12 = 0;
  __pyx_r = __pyx_t_20;
  __pyx_t_20 = 0;
 ...
 */
  ...
  __Pyx_AddTraceback("evaluations.taillard_acceleration", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_best_makespans);
  __Pyx_XDECREF(__pyx_v_best_positions);
...
/* Python wrapper */
static PyObject *__pyx_pw_11evaluations_1taillard_acceleration(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_11evaluations_1taillard_acceleration(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_sequence = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_processing_times = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_job_to_insert;
  int __pyx_v_machines_number;
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_sequence,&__pyx_n_s_processing_times,&__pyx_n_s_job_to_insert,&__pyx_n_s_machines_number,&__pyx_n_s_use_tie_breaking,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_processing_times)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("taillard_acceleration", 1, 5, 5, 1); __PYX_ERR(0, 33, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_job_to_insert)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("taillard_acceleration", 1, 5, 5, 2); __PYX_ERR(0, 33, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_machines_number)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("taillard_acceleration", 1, 5, 5, 3); __PYX_ERR(0, 33, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_use_tie_breaking)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("taillard_acceleration", 1, 5, 5, 4); __PYX_ERR(0, 33, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "taillard_acceleration") < 0)) __PYX_ERR(0, 33, __pyx_L3_error)
      }
    ...
    __pyx_v_sequence = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_sequence.memview)) __PYX_ERR(0, 33, __pyx_L3_error)
    __pyx_v_processing_times = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_processing_times.memview)) __PYX_ERR(0, 33, __pyx_L3_error)
    __pyx_v_job_to_insert = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_job_to_insert == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 33, __pyx_L3_error)
    __pyx_v_machines_number = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_machines_number == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 33, __pyx_L3_error)
    __pyx_v_use_tie_breaking = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_use_tie_breaking == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 33, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("taillard_acceleration", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 33, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("evaluations.taillard_acceleration", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_11evaluations_taillard_acceleration(__pyx_self, __pyx_v_sequence, __pyx_v_processing_times, __pyx_v_job_to_insert, __pyx_v_machines_number, __pyx_v_use_tie_breaking);
...
static PyObject *__pyx_pf_11evaluations_taillard_acceleration(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_sequence, __Pyx_memviewslice __pyx_v_processing_times, int __pyx_v_job_to_insert, int __pyx_v_machines_number, int __pyx_v_use_tie_breaking) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __Pyx_RefNannySetupContext("taillard_acceleration", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_sequence.memview)) { __Pyx_RaiseUnboundLocalError("sequence"); __PYX_ERR(0, 33, __pyx_L1_error) }
  if (unlikely(!__pyx_v_processing_times.memview)) { __Pyx_RaiseUnboundLocalError("processing_times"); __PYX_ERR(0, 33, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_11evaluations_taillard_acceleration(__pyx_v_sequence, __pyx_v_processing_times, __pyx_v_job_to_insert, __pyx_v_machines_number, __pyx_v_use_tie_breaking, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 33, __pyx_L1_error)
...
static PyObject *__pyx_f_11evaluations_tie_breaking(__Pyx_memviewslice __pyx_v_processing_times, __Pyx_memviewslice __pyx_v_position, __Pyx_memviewslice __pyx_v_funct, __Pyx_memviewslice __pyx_v_ms, int __pyx_v_job_to_insert, int __pyx_v_best_position, int __pyx_v_sequence_length, int __pyx_v_machines_number) {
  int __pyx_v_best_makespan;
 ...
 */
          ...
          __pyx_t_12 = (__pyx_v_job_to_insert - 1);
          __pyx_t_13 = (__pyx_v_j - 1);
          __pyx_v_itr = (__pyx_v_itr + (((*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_funct.data + __pyx_t_1 * __pyx_v_funct.strides[0]) ) + __pyx_t_9 * __pyx_v_funct.strides[1]) ))) - (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_position.data + __pyx_t_10 * __pyx_v_position.strides[0]) ) + __pyx_t_11 * __pyx_v_position.strides[1]) )))) - (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_processing_times.data + __pyx_t_12 * __pyx_v_processing_times.strides[0]) ) + __pyx_t_13 * __pyx_v_processing_times.strides[1]) )))));
        }
 ...
 */
      /*else*/ {
        ...
        __pyx_t_10 = 0;
        ((__pyx_v_fl[__pyx_v_i])[1]) = ((*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_funct.data + __pyx_t_13 * __pyx_v_funct.strides[0]) ) + __pyx_t_12 * __pyx_v_funct.strides[1]) ))) + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_processing_times.data + __pyx_t_11 * __pyx_v_processing_times.strides[0]) ) + __pyx_t_10 * __pyx_v_processing_times.strides[1]) ))));
 ...
 */
          ...
          __pyx_t_14 = (__pyx_v_job_to_insert - 1);
          __pyx_t_15 = (__pyx_v_j - 1);
          __pyx_v_itr = (__pyx_v_itr + ((((*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_funct.data + __pyx_t_10 * __pyx_v_funct.strides[0]) ) + __pyx_t_11 * __pyx_v_funct.strides[1]) ))) - (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_position.data + __pyx_t_12 * __pyx_v_position.strides[0]) ) + __pyx_t_13 * __pyx_v_position.strides[1]) )))) + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_processing_times.data + __pyx_t_9 * __pyx_v_processing_times.strides[0]) ) + __pyx_t_1 * __pyx_v_processing_times.strides[1]) )))) - (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_processing_times.data + __pyx_t_14 * __pyx_v_processing_times.strides[0]) ) + __pyx_t_15 * __pyx_v_processing_times.strides[1]) )))));
 ...
 */
          ...
          __pyx_t_5 = (((((__pyx_v_fl[__pyx_v_i])[(__pyx_v_j - 1)]) - (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_funct.data + __pyx_t_15 * __pyx_v_funct.strides[0]) ) + __pyx_t_14 * __pyx_v_funct.strides[1]) )))) > 0) != 0);
          if (__pyx_t_5) {
 ...
 */
            ...
            __pyx_v_itr = (__pyx_v_itr + (((__pyx_v_fl[__pyx_v_i])[(__pyx_v_j - 1)]) - (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_funct.data + __pyx_t_14 * __pyx_v_funct.strides[0]) ) + __pyx_t_15 * __pyx_v_funct.strides[1]) )))));
 ...
 */
          __pyx_t_15 = __pyx_v_i;
          __pyx_t_14 = __pyx_v_j;
          __pyx_t_5 = ((((__pyx_v_fl[__pyx_v_i])[(__pyx_v_j - 1)]) > (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_funct.data + __pyx_t_15 * __pyx_v_funct.strides[0]) ) + __pyx_t_14 * __pyx_v_funct.strides[1]) )))) != 0);
          if (__pyx_t_5) {
 ...
 * 				itbp = itr
 */
      __pyx_t_5 = ((__pyx_v_itr < __pyx_v_itbp) != 0);
      if (__pyx_t_5) {
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_16 = __Pyx_PyInt_From_int(__pyx_v_best_position); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 149, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_16);
  __pyx_r = __pyx_t_16;
  __pyx_t_16 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_16);
  __Pyx_AddTraceback("evaluations.tie_breaking", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
static PyObject *__pyx_pw_11evaluations_3calculate_completion_times(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_11evaluations_calculate_completion_times(__Pyx_memviewslice __pyx_v_sequence, __Pyx_memviewslice __pyx_v_processing_times, int __pyx_v_machines_number, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_sequence_length;
  int __pyx_v_i;
  int __pyx_v_j;
 ...
 */
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_n_s_zeros); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 159, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyInt_From_long((__pyx_v_sequence_length + 1)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 159, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyInt_From_long((__pyx_v_machines_number + 1)); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 159, __pyx_L1_error)
  ...
  __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_4, __pyx_t_5); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 159, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_int(__pyx_t_3, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 159, __pyx_L1_error)
 ...
 */
    __pyx_t_10 = __pyx_v_i;
    __pyx_t_11 = 0;
    *((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_position.data + __pyx_t_10 * __pyx_v_position.strides[0]) )) + __pyx_t_11)) )) = 0;
 ...
 * 				position[0,j] = 0
 */
    __pyx_t_12 = (__pyx_v_machines_number + 1);
 ...
 */
        ...
        *((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_position.data + __pyx_t_11 * __pyx_v_position.strides[0]) )) + __pyx_t_10)) )) = 0;
 ...
 */
      ...
      __pyx_t_15 = (((*((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_position.data + __pyx_t_10 * __pyx_v_position.strides[0]) )) + __pyx_t_11)) ))) > (*((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_position.data + __pyx_t_16 * __pyx_v_position.strides[0]) )) + __pyx_t_17)) )))) != 0);
      if (__pyx_t_15) {
 ...
 */
        ...
        *((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_position.data + __pyx_t_19 * __pyx_v_position.strides[0]) )) + __pyx_t_20)) )) = ((*((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_position.data + __pyx_t_17 * __pyx_v_position.strides[0]) )) + __pyx_t_16)) ))) + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_processing_times.data + __pyx_t_10 * __pyx_v_processing_times.strides[0]) ) + __pyx_t_18 * __pyx_v_processing_times.strides[1]) ))));
 ...
 */
      /*else*/ {
        ...
        *((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_position.data + __pyx_t_20 * __pyx_v_position.strides[0]) )) + __pyx_t_19)) )) = ((*((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_position.data + __pyx_t_11 * __pyx_v_position.strides[0]) )) + __pyx_t_18)) ))) + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_processing_times.data + __pyx_t_16 * __pyx_v_processing_times.strides[0]) ) + __pyx_t_17 * __pyx_v_processing_times.strides[1]) ))));
      }
      __pyx_L8:;
    }
  }
 ...
 */
  ...
  __pyx_t_17 = __pyx_v_machines_number;
  __pyx_t_3 = __Pyx_PyInt_From_int((*((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_position.data + __pyx_t_10 * __pyx_v_position.strides[0]) )) + __pyx_t_17)) )))); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 171, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_r = __pyx_t_3;
  __pyx_t_3 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("evaluations.calculate_completion_times", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_11evaluations_3calculate_completion_times(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_11evaluations_3calculate_completion_times(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_sequence = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_processing_times = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_machines_number;
  int __pyx_lineno = 0;
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_sequence,&__pyx_n_s_processing_times,&__pyx_n_s_machines_number,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_processing_times)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("calculate_completion_times", 1, 3, 3, 1); __PYX_ERR(0, 154, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_machines_number)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculate_completion_times", 1, 3, 3, 2); __PYX_ERR(0, 154, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "calculate_completion_times") < 0)) __PYX_ERR(0, 154, __pyx_L3_error)
      }
    ...
    __pyx_v_sequence = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_sequence.memview)) __PYX_ERR(0, 154, __pyx_L3_error)
    __pyx_v_processing_times = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_processing_times.memview)) __PYX_ERR(0, 154, __pyx_L3_error)
    __pyx_v_machines_number = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_machines_number == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 154, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("calculate_completion_times", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 154, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("evaluations.calculate_completion_times", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_11evaluations_2calculate_completion_times(__pyx_self, __pyx_v_sequence, __pyx_v_processing_times, __pyx_v_machines_number);
...
static PyObject *__pyx_pf_11evaluations_2calculate_completion_times(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_sequence, __Pyx_memviewslice __pyx_v_processing_times, int __pyx_v_machines_number) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("calculate_completion_times", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_sequence.memview)) { __Pyx_RaiseUnboundLocalError("sequence"); __PYX_ERR(0, 154, __pyx_L1_error) }
  if (unlikely(!__pyx_v_processing_times.memview)) { __Pyx_RaiseUnboundLocalError("processing_times"); __PYX_ERR(0, 154, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_11evaluations_calculate_completion_times(__pyx_v_sequence, __pyx_v_processing_times, __pyx_v_machines_number, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 154, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_pw_11evaluations_5idle_times_calc(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_11evaluations_idle_times_calc(__Pyx_memviewslice __pyx_v_sequence, __Pyx_memviewslice __pyx_v_processing_times, int __pyx_v_machines_number, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_sequence_length;
  int __pyx_v_i;
  int __pyx_v_j;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("idle_times_calc", 0);
 ...
 * 
 */
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_n_s_zeros); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 181, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_sequence_length); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 181, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_dtype, __pyx_n_s_int32) < 0) __PYX_ERR(0, 181, __pyx_L1_error)
  __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_4, __pyx_t_3); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 181, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 181, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 */
  __pyx_t_5 = __pyx_f_11evaluations_calculate_completion_times(__pyx_v_sequence, __pyx_v_processing_times, __pyx_v_machines_number, 0); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 184, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_int(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 184, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 */
    __pyx_t_13 = (__pyx_v_machines_number + 1);
 ...
 */
      ...
      *((int *) ( /* dim=0 */ (__pyx_v_idle_time.data + __pyx_t_22 * __pyx_v_idle_time.strides[0]) )) += (((*((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_position.data + __pyx_t_11 * __pyx_v_position.strides[0]) )) + __pyx_t_12)) ))) - (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_processing_times.data + __pyx_t_17 * __pyx_v_processing_times.strides[0]) ) + __pyx_t_18 * __pyx_v_processing_times.strides[1]) )))) - (*((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_position.data + __pyx_t_19 * __pyx_v_position.strides[0]) )) + __pyx_t_20)) ))));
    }
  }
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_5 = __pyx_memoryview_fromslice(__pyx_v_idle_time, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 190, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_3 = __pyx_memoryview_fromslice(__pyx_v_position, 2, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 190, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
 ...
 */
  ...
  __Pyx_AddTraceback("evaluations.idle_times_calc", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_11evaluations_5idle_times_calc(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_11evaluations_5idle_times_calc(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_sequence = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_processing_times = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_machines_number;
  int __pyx_lineno = 0;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("idle_times_calc (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_sequence,&__pyx_n_s_processing_times,&__pyx_n_s_machines_number,0};
    PyObject* values[3] = {0,0,0};
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_processing_times)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("idle_times_calc", 1, 3, 3, 1); __PYX_ERR(0, 176, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_machines_number)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("idle_times_calc", 1, 3, 3, 2); __PYX_ERR(0, 176, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "idle_times_calc") < 0)) __PYX_ERR(0, 176, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 3) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_sequence = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_sequence.memview)) __PYX_ERR(0, 176, __pyx_L3_error)
    __pyx_v_processing_times = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_processing_times.memview)) __PYX_ERR(0, 176, __pyx_L3_error)
    __pyx_v_machines_number = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_machines_number == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 176, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("idle_times_calc", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 176, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("evaluations.idle_times_calc", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_11evaluations_4idle_times_calc(__pyx_self, __pyx_v_sequence, __pyx_v_processing_times, __pyx_v_machines_number);
...
static PyObject *__pyx_pf_11evaluations_4idle_times_calc(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_sequence, __Pyx_memviewslice __pyx_v_processing_times, int __pyx_v_machines_number) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("idle_times_calc", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_sequence.memview)) { __Pyx_RaiseUnboundLocalError("sequence"); __PYX_ERR(0, 176, __pyx_L1_error) }
  if (unlikely(!__pyx_v_processing_times.memview)) { __Pyx_RaiseUnboundLocalError("processing_times"); __PYX_ERR(0, 176, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_11evaluations_idle_times_calc(__pyx_v_sequence, __pyx_v_processing_times, __pyx_v_machines_number, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 176, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "evaluations.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "evaluations._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"taillard_acceleration", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_11evaluations_1taillard_acceleration, METH_VARARGS|METH_KEYWORDS, 0},
  {"calculate_completion_times", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_11evaluations_3calculate_completion_times, METH_VARARGS|METH_KEYWORDS, 0},
  {"idle_times_calc", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_11evaluations_5idle_times_calc, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_evaluations(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_evaluations},
  {0, NULL}
};
#endif
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "evaluations",
    __pyx_k_MIT_License_Copyright_c_2018_js, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_job_to_insert, __pyx_k_job_to_insert, sizeof(__pyx_k_job_to_insert), 0, 0, 1, 1},
  {&__pyx_n_s_join, __pyx_k_join, sizeof(__pyx_k_join), 0, 0, 1, 1},
  {&__pyx_n_s_machines_number, __pyx_k_machines_number, sizeof(__pyx_k_machines_number), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initevaluations(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initevaluations(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_evaluations(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_evaluations(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_evaluations(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'evaluations' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_evaluations(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("evaluations", __pyx_methods, __pyx_k_MIT_License_Copyright_c_2018_js, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_evaluations) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "evaluations")) {
      if (unlikely(PyDict_SetItemString(modules, "evaluations", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_ImportFrom(__pyx_t_2, __pyx_n_s_zeros); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init evaluations", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init evaluations");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
